...
<template>
    ...
    <div class="mx-auto flex w-full max-w-2xl flex-col gap-4 p-4">
        ...
        <div
            ...
            class="rounded-xl border border-sidebar-border/70 p-8 text-center text-muted-foreground dark:border-sidebar-border"
        >
        ...
        <button
            ...
            :key="notification.id"
            type="button"
            class="flex items-start justify-between gap-3 rounded-xl border border-sidebar-border/70 p-4 text-left transition hover:bg-muted/50 dark:border-sidebar-border"
            :class="notification.read ? 'opacity-60' : ''"
            @click="open(notification)"
        >
            <div>
                <p class="text-sm" :class="notification.read ? '' : 'font-medium'">
